    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          <h4 class="text-black">We've recently reopened but have a revised menu, please <a class="js-scroll-trigger" href="#contact">call or pop in</a> for more information.</h4>
        </div>
      </div>
    </div>
  </section>
